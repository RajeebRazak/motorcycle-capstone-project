        ...
        <div className="card-body">
          <div className="table-responsive">
            <table className="table table-bordered m-0">
              <thead>
                <tr>
                  <th className="text-center py-3 px-4 min-w-[400px]">
                    Product Name & Details
                  </th>
                  <th className="text-right py-3 px-4 w-[100px]">Price</th>
                  <th className="text-center py-3 px-4 w-[120px]">Quantity</th>
                  <th className="text-right py-3 px-4 w-[100px]">Total</th>
                  <th className="text-center align-middle py-3 px-0 w-[40px]">
                    <Link
                      to="#"
